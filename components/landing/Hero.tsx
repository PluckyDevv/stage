      ...
      <div className="container mx-auto max-w-4xl text-center space-y-6 sm:space-y-8">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-3 sm:gap-4 pt-2 sm:pt-4 px-4 sm:px-0 w-full sm:w-auto">
          <Link href={ctaHref} className="w-full sm:w-auto">
            <Button size="lg" className="rounded-lg w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white shadow-md hover:shadow-lg transition-all touch-manipulation min-h-[44px] text-base sm:text-lg">
              {ctaLabel}
            </Button>
          </Link>
          <Link href="" className="w-full sm:w-auto">
            <Button size="lg" variant="outline" className="rounded-lg w-full sm:w-auto border-blue-600 text-blue-600 hover:bg-blue-50 hover:border-blue-700 touch-manipulation min-h-[44px] text-base sm:text-lg">
              View Demo
            </Button>
          </Link>
        </div>
